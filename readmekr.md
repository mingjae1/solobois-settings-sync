...
- 등록/해제: `soloboisSettingsSync.registerPrivateExtension`, `soloboisSettingsSync.removePrivateExtension`
- 자동 감지: `soloboisSettingsSync.autoDetectPrivateExtensions`
- VSIX 포함 업로드: `soloboisSettingsSync.uploadPrivateVsixToGist`
